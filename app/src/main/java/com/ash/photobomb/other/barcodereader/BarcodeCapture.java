package com.ash.photobomb.other.barcodereader;
...
import com.ash.photobomb.other.barcodereader.mobilevisionbarcodescanner.BarcodeFragment;
import com.ash.photobomb.other.barcodereader.ui.camera.CameraSourcePreview;
import com.ash.photobomb.other.barcodereader.ui.camera.GraphicOverlay;
import com.ash.photobomb.other.barcodereader.ui.camera.CameraSource;
...
public final class BarcodeCapture extends BarcodeFragment {
    ...
    public void requestCameraPermission() {
        ...
        if (ActivityCompat.checkSelfPermission(requireActivity(), Manifest.permission.CAMERA)
            ...
            ActivityCompat.requestPermissions(requireActivity(), new String[]{Manifest.permission.CAMERA}, RC_HANDLE_CAMERA_PERM);
        }
        else {
...
//            mCameraSource.setCameraFacing(Camera.Parameters.FLASH_MODE_ON);
            mCameraSource.stop();
